...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        //Retorna uma nova coleção, com os nomes concatenados com a quantidade de letra de cada nome
        System.out.println("Retorna uma nova coleção com a quantidade de letras: "
                + estudantes.stream().map(estudante -> estudante.concat(" - "). concat(
                        String.valueOf(estudante.length()))).collect(Collectors.toList()));

        //retorna somente os 3 primeiros elementos da coleção
        System.out.println("Retorna os 3 primeiros elementos da coleção: "
        ...
        //Retorna true se algum elemento possuir a letra A minúscula no nome
